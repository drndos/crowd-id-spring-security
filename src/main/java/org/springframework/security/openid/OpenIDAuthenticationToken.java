...
public class OpenIDAuthenticationToken extends AbstractAuthenticationToken {
  ...
  private final Map<String, String> sRegAttributes;

  // ~ Constructors
  // ===================================================================================================

  public OpenIDAuthenticationToken(OpenIDAuthenticationStatus status,
      String identityUrl, String message, List<OpenIDAttribute> attributes, Map<String, String> sRegAttributes) {
  ...
  public OpenIDAuthenticationToken(Object principal,
      ...
      List<OpenIDAttribute> attributes, Map<String, String> sRegAttributes) {
    super(authorities);
